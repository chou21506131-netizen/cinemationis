...
studios:
  - J.C.Staff
realisateur: Youhei Suzuki
resume_court: Dans un futur proche, tout ce qui est en rapport avec le sexe est banni au Japon.
image: "https://myanimelist.net/images/anime/6/75106l.jpg"
...
Shimozeka se rapproche pas mal d'un autre animé du même genre, [[Prison School]], mais en plus soft au niveau des images (pas des dialogues par contre !). Petite précision si jamais vous souhaitez le voir : la fin n'en est pas vraiment une donc pas mal d'éléments sont laissés en suspend.

De base le scénario n'est pas la préoccupation principale, mais y a un petit côté frustrant quand même.
